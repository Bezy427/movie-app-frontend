            ...
            <div className="row">
                <div className="col-md-6 mb-4">
                    <img
                        ...
                        alt="Product" className="img-fluid rounded mb-3 product-image" id="mainImage"/>
                ...
                <div className="col-md-6">
                    ...
                    <p className="mb-4">Experience premium sound quality and industry-leading noise cancellation with
                        these wireless
